...
let encodedSymbols = [
  8, 28, 36, 52, 56, 40, 23, 31, 56, 39, 38, 28, 48, 52, 58, 56, 38, 27, 32, 37,
  56, 40, 23, 31, 56, 39, 38, 41, 39, 32, 57,
];
...
const enigma = (encodedSymbols) => {
  for (let i = 0; i < encodedSymbols.length; i++) {
    let decodedIndex = encodedSymbols[i] + shift;
    if (decodedIndex > symbols.length) {
      message.push(symbols[decodedIndex - symbols.length]);
    } else {
      message.push(symbols[decodedIndex]);
    }
    decodedMessage = message.join("");
  }
  return decodedMessage;
};

console.log(enigma(encodedSymbols));

let encodedSymbols2 = [
  8, 34, 38, 35, 52, 34, 38, 56, 39, 41, 23, 56, 37, 28, 56, 34, 38, 40, 36, 32,
  58, 56, 38, 37, 56, 25, 41, 29, 56, 40, 23, 25, 37, 38, 56, 25, 56, 36, 38,
  54, 56, 36, 32, 41, 34, 43, 56, 41, 36, 38, 42, 40, 32, 42, 60,
];
let encodedSymbols3 = [
...
let encodedSymbols4 = [
  13, 25, 28, 42, 38, 34, 56, 37, 23, 56, 39, 38, 35, 56, 59, 56, 39, 38, 27,
  38, 34, 38, 37, 37, 32, 34, 43, 56, 35, 28, 26, 47, 28, 60,
];
let encodedSymbols5 = [
  4, 28, 31, 25, 23, 37, 51, 33, 56, 39, 51, 35, 28, 41, 38, 41, 56, 45, 43, 30,
  28, 56, 25, 28, 37, 32, 34, 23, 57,
];

let encodedSymbols6 = [
  2, 43, 47, 48, 28, 56, 34, 38, 42, 35, 28, 42, 23, 56, 25, 56, 31, 43, 24, 23,
  45, 58, 56, 47, 28, 36, 56, 41, 32, 37, 32, 46, 23, 56, 25, 56, 37, 28, 24,
  28, 57,
];
